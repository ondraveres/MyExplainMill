...
function flatsearch!(f, ms::AbstractExplainMask, scorefun; rev::Bool = true, fine_tuning::Bool = false, max_n = 5, random_removal::Bool = true)
	fv = FlatView(ms)
...
function flatsfs!(f, ms::AbstractExplainMask, scorefun; participateonly::Bool = false, fine_tuning::Bool = false, max_n = 5, random_removal::Bool = true)
	fv = FlatView(ms)
	flatsfs!(f, fv, max_n = max_n, random_removal = random_removal, fine_tuning = fine_tuning)
end

function flatsfs!(f, ms::AbstractExplainMask; participateonly::Bool = false, fine_tuning::Bool = false, max_n = 5, random_removal::Bool = true)
	fv = FlatView(ms)
	flatsfs!(f, fv, max_n = max_n, random_removal = random_removal, fine_tuning = fine_tuning)
end
